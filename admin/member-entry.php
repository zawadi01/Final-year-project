...
<!--Header-part--><!--fitness system---->
<div id="header">
  <h1><a href="dashboard.html">Fit Gym Admin</a></h1>
</div>
<!--close-Header-part--> 
        ...
        <div class="widget-content nopadding">
          <div class="form-horizontal">
            <div class="control-group">
              ...
              <div class="controls">
                <input type="number" id="mask-phone" name="contact" placeholder="+254 7......" class="span8 mask text">
                <span class="help-block blue span8">For assistance contact: +254 720952222</span> 
                </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <label>
                  ...
                  Fitness <small>- Ksh 11000 per month</small></label>
                <label>
                  <input type="radio" value="Sauna" name="services" />
                  Sauna <small>- Ksh 8000 per month</small></label>
                <label>
                  <input type="radio" value="Cardio" name="services" />
                  Cardio <small>- Ksh 9000 per month</small></label>
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <div class="input-append">
                  ...
                  <input type="number" placeholder="00" name="amount" class="span11">
                  </div>
              </div>
            </div>
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date("Y");?> &copy; Developed by Zawadi Mwikali </a> </div>
</div>
