  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        ...
        <li class="bg_lg span3"> <a href="payment.php" style="font-size: 16px;"> <i class="fas fa-dollar sign"></i> Total Earnings: Ksh<?php include'income-count.php' ?></a> </li>
...
<script src="../js/excanvas.min.js"></script> <!--fitness system---->
