              ...
              <div class="span5">
                <table class="">
                  ...
                  <tr>
                    ...
                    <tr>
                      <td>Tel: 0792223221</td>
                    </tr>
                    <tr>
                      <td >Email: support@fitgym.com</td>
                    </tr>
                  </tbody>
                </table>
              </div>
                ...
                <table class="table table-bordered table-invoice">
				  ...
				  <form action="userpay.php" method="POST">
                    ...
                    <tr>
                      ...
                      <td><input id="amount" type="number" name="amount" value='<?php if($row['services'] == 'Fitness') { echo '11000';} elseif ($row['services'] == 'Sauna') { echo '8000';} else {echo '9000';} ?>' /></td>
                    </tr>
