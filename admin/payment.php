...
<!--top-Header-menu--><!--fitness system---->
        ...
        $result=mysqli_query($conn,$qry);
          ...
          echo"<table class='table table-bordered data-table table-hover'>
            ...
            <tbody> 
                ...
                <td><div class='text-center'><a href='user-payment.php?id=<?php echo $row['user_id']?>'><button class='btn btn-success btn'><i class='Ksh'></i> Make Payment</button></a></div></td>
